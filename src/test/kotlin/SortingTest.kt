...
class SortingTest {
    ...
    @Nested
    inner class BubbleSort {

        @Test
        fun `bubbleSort should work on an empty array`() {
            // Arrange
            val array = arrayOf<Int>()
        ...
        @Test
        fun `bubbleSort should work on an array of one`() {
            // Arrange
            val array = arrayOf<Int>(5)
        ...
        @Test
        fun `bubbleSort should work on a sorted array`() {
            // Arrange
            val array = arrayOf<Int>(-2, -1, 0, 1, 2, 3)
        ...
        @Test
        fun `bubbleSort should work on a completely random array`() {
            // Arrange
            val array = arrayOf<Int>(7, 15, 460, -19, 2, -5)
        ...
        @Test
        fun `bubbleSort should work on an array sorted in reverse order`() {
            // Arrange
            val array = arrayOf<Int>(3, 2, 1, 0, -1, -2)
        ...
        @Test
        fun `bubbleSort should work on an array with multiple of the same value`() {
            // Arrange
            val array = arrayOf<Int>(1, 2, 3, 3, 3, 1)
        ...
        @Test
        fun `bubbleSort should work on an array of strings`() {
            // Arrange
            val array = arrayOf<String>("z", "b", "q", "f", "i", "a")
    ...
    inner class MergeSort {
        ...
        @Test
        fun `mergeSort should work on an empty array`() {
            // Arrange
            val array = arrayOf<Int>()
        ...
        @Test
        fun `mergeSort should work on an array of one`() {
            // Arrange
            val array = arrayOf<Int>(5)
        ...
        @Test
        fun `mergeSort should work on a sorted array`() {
            // Arrange
            val array = arrayOf<Int>(-2, -1, 0, 1, 2, 3)
        ...
        @Test
        fun `mergeSort should work on a completely random array`() {
            // Arrange
            val array = arrayOf<Int>(7, 15, 460, -19, 2, -5)
        ...
        @Test
        fun `mergeSort should work on an array sorted in reverse order`() {
            // Arrange
            val array = arrayOf<Int>(3, 2, 1, 0, -1, -2)
        ...
        @Test
        fun `mergeSort should work on an array with multiple of the same value`() {
            // Arrange
            val array = arrayOf<Int>(1, 2, 3, 3, 3, 1)
        ...
        @Test
        fun `mergeSort should work on an array of strings`() {
            // Arrange
            val array = arrayOf<String>("z", "b", "q", "f", "i", "a")
